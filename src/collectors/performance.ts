...
export class PerformanceCollector {
  ...
  private screenTimings: Map<string, ScreenRenderTiming> = new Map();
  private frameMonitorId: ReturnType<typeof setInterval> | null = null;
  ...
  // Private methods
  private trackAppStartTime(): void {
